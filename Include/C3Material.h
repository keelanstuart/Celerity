...
namespace c3
{
	...
	public:
		...
		virtual void SetTexture(TextureComponentType comptype, const Texture *ptex, props::TFlags32 texflags = TEXFLAG_MAGFILTER_LINEAR | TEXFLAG_MINFILTER_LINEAR | TEXFLAG_MINFILTER_MIPLINEAR | TEXFLAG_WRAP_U | TEXFLAG_WRAP_V) = NULL;

		/// Sets a texture resource for the given type
		virtual void SetTexture(TextureComponentType comptype, const Resource *ptexres, props::TFlags32 texflags = TEXFLAG_MAGFILTER_LINEAR | TEXFLAG_MINFILTER_LINEAR | TEXFLAG_MINFILTER_MIPLINEAR | TEXFLAG_WRAP_U | TEXFLAG_WRAP_V) = NULL;

		/// Gets the texture for the given type, texflags receives the texture flags for it if provided
		virtual const Texture *GetTexture(TextureComponentType comptype, props::TFlags32 *texflags = nullptr) const = NULL;
