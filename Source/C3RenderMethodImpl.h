...
namespace c3
{
	...
	DEFINE_RESOURCETYPE(RenderMethod, 0, GUID({0x2e5ad016, 0x955c, 0x4dba, { 0x8f, 0x15, 0xf1, 0x39, 0x4e, 0x20, 0x82, 0xea }}),
		"RenderMethod", "Render Methods");

	DEFINE_RESOURCECODEC(RenderMethodASCII, RenderMethod, 0, GUID({ 0xe85210a9, 0x19f6, 0x401c, { 0x82, 0xab, 0x10, 0x34, 0x7d, 0x80, 0xdb, 0x3d }}),
		"RenderMethodASCII", "Loads RenderMethods From ASCII text", "c3rm", "c3rm", 1);
