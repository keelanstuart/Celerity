...
namespace c3
{
	...
	DEFINE_RESOURCETYPE(Animation, 0,
		GUID({ 0x3dd51727, 0xe26e, 0x4f9c, { 0xbd, 0xe6, 0x44, 0x6c, 0xa1, 0xcc, 0xb1, 0x1f }}),
		"Animation", "3D Animation Data");

	DEFINE_RESOURCECODEC(AnimationXAF, Animation, 0,
		GUID({ 0x991d80c4, 0x707a, 0x4a15, { 0xaf, 0xc9, 0xae, 0x7f, 0xa2, 0x8b, 0x4, 0x46 } }),
		"AnimationXAF", "XAF Animation Data",
		"xaf", "xaf", 0);
